...
class Sensor:
    def __init__(self, bus, address):
        ...
        self.pollutants = []
        polluntants_str = self.__get_from_sensor("pollutants")
        for pollutant in polluntants_str.split(","):
            try:
    ...
    def __get_from_sensor(self, what: str):
        write = i2c_msg.write(self.address, [x for x in f"get_{what}".encode("ascii")])
